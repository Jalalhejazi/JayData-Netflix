...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  $data.Entity.extend('Netflix.Catalog.v2.Title', {
    ...
    'Discs': { type:'Array',elementType:'Netflix.Catalog.v2.Title',inverseProperty:'$$unbound' },
    'Episodes': { type:'Array',elementType:'Netflix.Catalog.v2.Title',inverseProperty:'$$unbound' },
    'Genres': { type:'Array',elementType:'Netflix.Catalog.v2.Genre',inverseProperty:'Titles' },
    'Seasons': { type:'Array',elementType:'Netflix.Catalog.v2.Title',inverseProperty:'$$unbound' }
  });
  ...
  $data.EntityContext.extend('Netflix.NetflixCatalog', {
    Movies: $data.EntityContext.generateServiceOperation({ serviceName:'Movies', returnType: $data.Queryable, elementType: 'Netflix.Catalog.v2.Title',  method: 'GET'}),
      Series: $data.EntityContext.generateServiceOperation({ serviceName:'Series', returnType: $data.Queryable, elementType: 'Netflix.Catalog.v2.Title',  method: 'GET'}),
      Seasons: $data.EntityContext.generateServiceOperation({ serviceName:'Seasons', returnType: $data.Queryable, elementType: 'Netflix.Catalog.v2.Title',  method: 'GET'}),
      Discs: $data.EntityContext.generateServiceOperation({ serviceName:'Discs', returnType: $data.Queryable, elementType: 'Netflix.Catalog.v2.Title',  method: 'GET'}),
      Episodes: $data.EntityContext.generateServiceOperation({ serviceName:'Episodes', returnType: $data.Queryable, elementType: 'Netflix.Catalog.v2.Title',  method: 'GET'}),
